...
A tiny iOS app that converts and resizes photos, saving the outputs to a "Resize" album in the user's Photos library. Built with SwiftUI on iOS 26.
...
5. Tap Process. Converted copies land in the **Resize** album in Photos with EXIF metadata preserved.
